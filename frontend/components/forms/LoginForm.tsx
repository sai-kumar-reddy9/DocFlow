...
// Inline Icon Components for maximum reliability and 0 dependencies
const MailIcon = () => (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert("Password reset feature will be available once backend is connected.");
              }}
        ...
        <div className="flex items-center">
          <input
            ...
            onChange={handleChange}
            className="h-4 w-4 rounded bg-slate-900 border-slate-800 text-indigo-600 focus:ring-indigo-500/20 focus:ring-offset-0 accent-indigo-600 cursor-pointer"
          />
          <label htmlFor="rememberMe" className="ml-2.5 text-xs text-slate-400 cursor-pointer select-none">
